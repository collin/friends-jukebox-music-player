Gem::Specification.new do |s|
  ...
  s.files = ["LICENSE", "README.textile", "Rakefile", "TODO", "lib/merb-auth-core.rb", "lib/merb-auth-core", "lib/merb-auth-core/authenticated_helper.rb", "lib/merb-auth-core/authentication.rb", "lib/merb-auth-core/errors.rb", "lib/merb-auth-core/merbtasks.rb", "lib/merb-auth-core/session_mixin.rb", "lib/merb-auth-core/strategy.rb", "spec/helpers", "spec/helpers/authentication_helper_spec.rb", "spec/merb-auth-core", "spec/merb-auth-core/authentication_spec.rb", "spec/merb-auth-core/errors_spec.rb", "spec/merb-auth-core/merb-auth-core_spec.rb", "spec/merb-auth-core/strategy_spec.rb", "spec/spec_helper.rb"]
  s.has_rdoc = true
